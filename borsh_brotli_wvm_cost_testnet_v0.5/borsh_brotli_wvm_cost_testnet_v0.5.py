...
GWEI_TO_ETH = 1e-9
ETH_BASE_FEE_GWEI = 1.2
WVM_BASE_FEE_GWEI = 0.000000007
CELESTIA_BASE_FEE_GWEI = 8
BASE_BASE_FEE_GWEI = 0.03
ARB_BASE_FEE_GWEI = 0.351
EIGEN_DA_PER_GB_PRICE = 0.15 # 0.15 ETH
CELETIA_GAS_PRICE = 0.002358 # uTIA source: https://celenium.io/gas
...
def weavevm_1mb_usd_cost():
    ...
    wvm_1mb_calldata = WVM_CALLDATA_GAS_PER_BYTE * CASE_STUDY_1MB * WVM_BASE_FEE_GWEI * GWEI_TO_ETH * 3.25
...
costs = [weavevm_1mb_usd_cost(),eigenda_1mb_usd_cost(), celestia_1MB_usd_cost(), base_calldata_1mb_usd_cost(), arb_calldata_1mb_usd_cost()] # add: eth_calldata_1mb_usd_cost()
