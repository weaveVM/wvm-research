...
length_json_data = len(json.dumps(sample_data))

# Data for plotting
labels = ['Borsh', 'JSON']
lengths = [length_built_data, length_json_data]

# Plotting
plt.style.use('dark_background')
fig, ax = plt.subplots()

bars = ax.bar(labels, lengths, color='green')
...
ax.set_title('Comparison of an empty block size: Borsh vs JSON serialization')

plt.savefig("./borsh_vs_json_serialization/compare.png")
plt.show()
